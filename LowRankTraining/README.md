...
1. Test conversion on a tiny model.
2. Save a low-rank checkpoint.
3. Run a short pretraining smoke test.
4. Resume from the saved checkpoint.
5. Move to a larger model only after the small tests work.
